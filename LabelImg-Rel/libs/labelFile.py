...
class LabelFile(object):
    ...
    def save_create_ml_format(self, filename, shapes, predicates, image_path, image_data, class_list, line_color=None, fill_color=None, database_src=None):
        ...
        writer = CreateMLWriter(img_folder_name, img_file_name,
                                image_shape, shapes, predicates, filename, local_img_path=image_path)
        writer.verified = self.verified
        writer.write()

    def save_pascal_voc_format(self, filename, shapes, predicates, image_path, image_data,
