...
class predicateDialog(QDialog):
    ...
    def __init__(self, text="Enter object predicate", parent=None, list_item=None):
        super(predicateDialog, self).__init__(parent)
    ...
    def pop_up(self, text='', move=True):
        ...
        If the user entered a predicate, that predicate is returned, otherwise (i.e. if the user cancelled the action)
        `None` is returned.
        """
        self.edit.setText(text)
